...
function subscribeToPresence(watcherSocketID: string, targetUserID: string): void {
...
function unsubscribeFromPresence(watcherSocketID: string, targetUserID: string): void {
