...
export function MessageBubble({ message }: MessageBubbleProps) {
	...
	return (
		...
		>
			...
			>
				<p className="text-sm leading-relaxed wrap-break-word whitespace-pre-wrap">{content}</p>
				<div
					className={cn("flex items-center gap-1 mt-1", sentByMe ? "justify-end" : "justify-start")}
				>
